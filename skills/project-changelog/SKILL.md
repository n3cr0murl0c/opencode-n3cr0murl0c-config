...
| SDK        | `project/CHANGELOG.md`    | None           | 5.x.x           |
...
```markdown
## [X.Y.Z] (project vA.B.C) OR (project UNRELEASED)
...
- First entry [(#XXXX)](https://github.com/project-cloud/project/pull/XXXX)
- Second entry [(#YYYY)](https://github.com/project-cloud/project/pull/YYYY)

### Changed

- Another entry [(#ZZZZ)](https://github.com/project-cloud/project/pull/ZZZZ)
```
...
project follows [semver.org](https://semver.org/):
...
**NEVER modify already released versions.** Once a version is released (has a project version tag like `v5.16.0`), its changelog section is frozen.
...
```markdown
## [1.16.0] (project v5.16.0) ← RELEASED, DO NOT MODIFY

### Added

- Feature from merged PR [(#9999)] ← WRONG! PR merged after release

## [1.17.0] (project UNRELEASED) ← Move entry HERE
```
...
```markdown
## [1.17.0] (project UNRELEASED) # For unreleased changes

## [1.16.0] (project v5.16.0) # For released versions
...
```markdown
## [1.17.0] (project UNRELEASED)

### 🐞 Fixed

- Button alignment in dashboard header [(#9999)](https://github.com/project-cloud/project/pull/9999)
```
...
- Search bar when adding a provider [(#9634)](https://github.com/project-cloud/project/pull/9634)

### 🐞 Fixed

- OCI update credentials form failing silently due to missing provider UID [(#9746)](https://github.com/project-cloud/project/pull/9746)

### 🔐 Security

- Node.js from 20.x to 24.13.0 LTS, patching 8 CVEs [(#9797)](https://github.com/project-cloud/project/pull/9797)
```
...
1. **REQUIRED**: PRs touching `ui/`, `api/`, `mcp_server/`, or `project/` MUST update the corresponding changelog
