...
#   ~/.config/opencode/skills/setup.sh --opencode   # Sync to OpenCode config
#
# ============================================================================
...
sync_opencode() {
    ...
    log_info "Syncing skills From Claude to OpenCode config..."
    ...
    if [ -d "$commands_dir" ]; then
        ...
        cp "$commands_dir"/* "$opencode_dir/commands"
    ...
    if [ -d "$agents_dir" ]; then
        ...
        cp "$agents_dir"/* "$opencode_dir/agents"
...
sync_claude_config() {
    ...
    log_info "Syncing skills to From OpenCode/orlocal to Claude Code config..."
...
Examples:
  ~/.config/opencode/skills/setup.sh              # Interactive menu
  ~/.config/opencode/skills/setup.sh --all        # Generate all formats
  ~/.config/opencode/skills/setup.sh --claude     # Claude Code only
  ~/.config/opencode/skills/setup.sh --sync-all   # Sync to user configs
EOF
}
