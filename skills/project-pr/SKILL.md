...
name: project-pr
description: >
  Creates Pull Requests for project following the project template and conventions.
...
- [ ] This feature/issue is listed in [here](https://github.com/project-cloud/project/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or roadmap.project.com
- [ ] Is it assigned to me, if not, request it via the issue/feature in [here](https://github.com/project-cloud/project/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or [project Community Slack](goto.project.com/slack)
