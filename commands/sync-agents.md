Invoke the following command to sync agents from current directory. ask the user which agent to sync

```bash
~/.config/opencode/skills/setup.sh
```

for context this is the script:
#!/bin/bash
